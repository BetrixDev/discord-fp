...
declare function on<T extends keyof ClientEvents>(eventName: T, run: (...args: ClientEvents[T]) => Promisable<void>): void;
declare function once<T extends keyof ClientEvents>(eventName: T, run: (...args: ClientEvents[T]) => Promisable<void>): void;
...
declare function middleware(run: (next: () => void, interaction: Interaction, client: Client) => void): (next: () => void, interaction: Interaction, client: Client) => void;
...
export { DiscordFPHandlerOptions, button, command, handleInteraction, initInteractionHandler, middleware, modal, on, once, selectMenu };
